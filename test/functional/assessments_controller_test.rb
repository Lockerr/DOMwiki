...
class AssessmentsControllerTest < ActionController::TestCase
  ...
  test "should create assessment" do
    assert_difference('Assessment.count') do
      post :create, assessment: { assessment: @assessment.assessment, category_id: @assessment.category_id, description: @assessment.description }
    end
  ...
  test "should update assessment" do
    put :update, id: @assessment, assessment: { assessment: @assessment.assessment, category_id: @assessment.category_id, description: @assessment.description }
    assert_redirected_to assessment_path(assigns(:assessment))
  end
